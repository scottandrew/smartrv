...
#include "lvgl/src/extra/themes/default/lv_theme_default.h"
...
//   color_secondary_muted = lv_color_grey_darken_4();
    ...
    theme.color_primary = lv_color_black();
    theme.color_secondary = lv_color_white();
    ...
    lv_style_set_bg_color(&styles->card, lv_color_black());
    lv_style_set_border_color(&styles->card, COLOR_GREY);
    lv_style_set_border_width(&styles->card, 0);
    lv_style_set_border_post(&styles->card, true);
    lv_style_set_text_color(&styles->card, lv_color_white());
    ...
    lv_style_set_outline_width(&styles->outline_primary, 0);
    ...
    lv_style_set_outline_color(&styles->outline_secondary, color_secondary_accent);
