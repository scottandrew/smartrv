...
#define COLOR_SCR_TEXT lv_color_white()
...
#define PAD_DEF                                                                \
  (disp_size == DISP_LARGE    ? LV_DPX(24)                                     \
   : disp_size == DISP_MEDIUM ? LV_DPX(20)                                     \
                              : LV_DPX(20))
#define PAD_SMALL                                                              \
  (disp_size == DISP_LARGE    ? LV_DPX(14)                                     \
   : disp_size == DISP_MEDIUM ? LV_DPX(12)                                     \
                              : LV_DPX(12))
#define PAD_TINY                                                               \
  (disp_size == DISP_LARGE    ? LV_DPX(8)                                      \
   : disp_size == DISP_MEDIUM ? LV_DPX(6)                                      \
                              : LV_DPX(2))
...
static void style_init(void) {
  ...
  color_primary_accent = lv_color_grey_lighten_5();
  color_secondary_accent = lv_color_grey_lighten_5();
  color_primary_muted = lv_color_grey_darken_4();
  color_secondary_muted = lv_color_grey_darken_4();
  ...
  lv_style_transition_dsc_init(&trans_delayed, trans_props, &lv_anim_path_def,
                               TRANSITION_TIME, 70);

  static lv_style_transition_dsc_t trans_normal;
  lv_style_transition_dsc_init(&trans_normal, trans_props, &lv_anim_path_def,
                               TRANSITION_TIME, 0);
  ...
  lv_style_set_radius(&styles->btn, (disp_size == DISP_LARGE    ? LV_DPX(16)
                                     : disp_size == DISP_MEDIUM ? LV_DPX(12)
                                                                : LV_DPX(8)));
  lv_style_set_bg_opa(&styles->btn, LV_OPA_COVER);
  lv_style_set_bg_color(&styles->btn, lv_color_black());
...
lv_theme_t *smart_rv_theme_default_init(lv_disp_t *disp) {
  ...
  theme.disp = disp;
  // theme.palette_primary = lv_color_white();
  // theme.palette_secondary = lv_color_gray();
  theme.palette_primary = LV_COLOR_PALETTE_NONE;
  theme.palette_secondary = LV_COLOR_PALETTE_NONE;
  theme.font_small = &lv_font_montserrat_12;
  theme.font_normal = &lv_font_montserrat_14;
  theme.font_large = &lv_font_montserrat_18;
...
bool lv_theme_default_is_inited(void) { return inited; }
...
static void theme_apply(lv_theme_t *th, lv_obj_t *obj) {
  ...
  if (lv_obj_get_parent(obj) == NULL) {
    ...
    lv_obj_add_style(obj, LV_PART_SCROLLBAR, LV_STATE_DEFAULT,
                     &styles->scrollbar);
    lv_obj_add_style(obj, LV_PART_SCROLLBAR, LV_STATE_SCROLLED,
  ...
  if (lv_obj_check_type(obj, &lv_obj_class)) {
    ...
    if (lv_obj_check_type(parent, &lv_tabview_class)) {
      lv_obj_add_style(obj, LV_PART_MAIN, LV_STATE_DEFAULT,
    ...
    /*Content*/
    else if (lv_obj_get_child_id(obj) == 1 &&
             lv_obj_check_type(lv_obj_get_parent(obj), &lv_win_class)) {
      lv_obj_add_style(obj, LV_PART_MAIN, LV_STATE_DEFAULT, &styles->scr);
      lv_obj_add_style(obj, LV_PART_MAIN, LV_STATE_DEFAULT,
                       &styles->pad_normal);
    ...
    lv_obj_add_style(obj, LV_PART_MAIN, LV_STATE_PRESSED,
                     &styles->transition_normal);
#if LV_THEME_DEFAULT_GROW
    lv_obj_add_style(obj, LV_PART_MAIN, LV_STATE_PRESSED, &styles->grow);
#endif
    lv_obj_add_style(obj, LV_PART_MAIN, LV_STATE_CHECKED,
    ...
    if (lv_obj_check_type(lv_obj_get_parent(obj), &lv_msgbox_class)) {
      ...
      lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_CHECKED,
                       &styles->bg_color_primary);
      lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_CHECKED,
                       &styles->bg_color_primary);
      lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_FOCUS_KEY,
    ...
    if (lv_obj_check_type(lv_obj_get_parent(obj), &lv_tabview_class)) {
      ...
      lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_DEFAULT,
                       &styles->bg_color_white);
      lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_PRESSED, &styles->pressed);
      lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_CHECKED,
...
#endif
    lv_obj_add_style(obj, LV_PART_MAIN, LV_STATE_DEFAULT, &styles->card);
    lv_obj_add_style(obj, LV_PART_MAIN, LV_STATE_FOCUS_KEY,
                     &styles->outline_primary);
    lv_obj_add_style(obj, LV_PART_MAIN, LV_STATE_EDITED,
    ...
    lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_FOCUS_KEY,
                     &styles->outline_primary);
    lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_EDITED,
                     &styles->outline_secondary);
  }
#endif
    ...
    lv_obj_add_style(obj, LV_PART_MAIN, LV_STATE_EDITED,
                     &styles->outline_secondary);
    lv_obj_add_style(obj, LV_PART_INDICATOR, LV_STATE_DEFAULT,
                     &styles->bg_color_primary);
    ...
    lv_obj_add_style(obj, LV_PART_KNOB, LV_STATE_DEFAULT,
                     &styles->transition_delayed);
    lv_obj_add_style(obj, LV_PART_KNOB, LV_STATE_PRESSED,
                     &styles->transition_normal);
  }
#endif
    ...
    lv_obj_add_style(obj, LV_PART_MAIN, LV_STATE_FOCUS_KEY,
                     &styles->outline_primary);
    lv_obj_add_style(obj, LV_PART_MAIN, LV_STATE_FOCUS_KEY,
                     &styles->cb_bg_outline_pad);
    lv_obj_add_style(obj, LV_PART_INDICATOR, LV_STATE_DISABLED,
                     &styles->disabled);
    lv_obj_add_style(obj, LV_PART_INDICATOR, LV_STATE_DEFAULT,
                     &styles->cb_marker);
    lv_obj_add_style(obj, LV_PART_INDICATOR, LV_STATE_CHECKED,
                     &styles->bg_color_primary);
    lv_obj_add_style(obj, LV_PART_INDICATOR, LV_STATE_CHECKED,
                     &styles->cb_marker_checked);
    lv_obj_add_style(obj, LV_PART_INDICATOR, LV_STATE_PRESSED,
                     &styles->pressed);
#if LV_THEME_DEFAULT_GROW
    ...
    lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_DEFAULT,
                     &styles->chart_series);
    lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_PRESSED,
                     &styles->bg_color_primary);
    lv_obj_add_style(obj, LV_PART_TICKS, LV_STATE_DEFAULT,
                     &styles->chart_ticks);
    lv_obj_add_style(obj, LV_PART_CURSOR, LV_STATE_DEFAULT,
                     &styles->chart_series);
  }
#endif
    ...
    lv_obj_add_style(obj, LV_PART_MAIN, LV_STATE_EDITED,
                     &styles->outline_secondary);
    lv_obj_add_style(obj, LV_PART_SELECTED, LV_STATE_DEFAULT,
                     &styles->bg_color_primary);
  }
#endif
...
//     lv_obj_add_style(obj, LV_PART_SELECTED, LV_STATE_DEFAULT,
//                      &styles->bg_color_white);
//     lv_obj_add_style(obj, LV_PART_SELECTED, LV_STATE_CHECKED,
//                      &styles->bg_color_primary);
...
//   }
    ...
    lv_obj_add_style(obj, LV_PART_TEXTAREA_PLACEHOLDER, LV_STATE_DEFAULT,
    ...
    lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_DEFAULT,
                     &styles->bg_color_white);
    lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_DEFAULT,
                     &styles->keyboard_btn_bg);
    lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_PRESSED, &styles->pressed);
    lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_CHECKED,
                     &styles->bg_color_grey);
    lv_obj_add_style(obj, LV_PART_ITEMS, LV_STATE_FOCUSED,
                     &styles->outline_primary);
  }
#endif
#if LV_USE_LIST
    ...
    lv_obj_add_style(obj, LV_PART_MAIN, LV_STATE_EDITED,
                     &styles->outline_secondary);
    lv_obj_add_style(obj, LV_PART_CURSOR, LV_STATE_FOCUSED,
                     &styles->bg_color_primary);
  }
#endif
#if LV_USE_TILEVIEW
